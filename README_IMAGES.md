...
| :--- | :--- |
| **Python** | ![Python](assets/badges/python.svg) |
| **TypeScript** | ![TypeScript](assets/badges/typescript.svg) |
| **React** | ![React](assets/badges/react.svg) |
| **Next.js** | ![Next.js](assets/badges/nextjs.svg) |
| **Node.js** | ![Node.js](assets/badges/nodejs.svg) |
| **Go** | ![Go](assets/badges/golang.svg) |
| **Rust** | ![Rust](assets/badges/rust.svg) |
| **PostgreSQL** | ![PostgreSQL](assets/badges/postgresql.svg) |
| **Docker** | ![Docker](assets/badges/docker.svg) |
| **AWS** | ![AWS](assets/badges/aws.svg) |
| **PyTorch** | ![PyTorch](assets/badges/pytorch.svg) |
| **Kubernetes** | ![Kubernetes](assets/badges/kubernetes.svg) |
| **Tailwind CSS** | ![Tailwind CSS](assets/badges/tailwind.svg) |
| **GraphQL** | ![GraphQL](assets/badges/graphql.svg) |
